<script>
  ...
  const onSubmit = e => {
    ...
    const data = compute(settings, dataWorkbook, orderWorkbook);
    onCompute(data);
  }
...
<form on:submit={onSubmit}>
  ...
  <fieldset>
    ...
    <div class="form-group">
      <label for="rating-provider">
        Ajuster l'importance de la note fournisseur :
      </label>
      <input
        id="rating-provider"
        type="number"
    ...
    <div class="form-group">
      <label for="rating-customer">
        Ajuster l'importance de la note client :
      </label>
      <input
        id="rating-customer"
        type="number"
